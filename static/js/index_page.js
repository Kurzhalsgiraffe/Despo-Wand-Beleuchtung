...
const canvasObject = new CanvasObject(canvas, FRAME_HEIGHT=700, FRAME_WIDTH=900, PIXEL_SIZE, colorArray=[]);
...
delete_btn.addEventListener("click", function() {
    canvasObject.c.clearRect(0, 0, canvasObject.FRAME_WIDTH, canvasObject.FRAME_HEIGHT);
...
function updateCell(x,y) {
    if (y < 700) {
        // compute coordinates of top left pixel for the 100x100 area
        x_start = x-x%PIXEL_SIZE;
        y_start = y-y%PIXEL_SIZE;
